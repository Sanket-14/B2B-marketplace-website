...
$secret_key = "voltbridge"; // Change this to your actual secret key

// Check if email and comp_name are set in the URL parameters
if(isset($_GET['email']) && isset($_GET['comp_name'])) {
    // Retrieve the encrypted email and company name from the URL parameters
    $encrypted_email = $_GET['email'];
    $encrypted_comp_name = $_GET['comp_name'];

    // Decrypt email
    $email = openssl_decrypt($encrypted_email, 'aes-256-cbc', $secret_key, 0, '1234567890123456');

    // Decrypt company name
    $comp_name = openssl_decrypt($encrypted_comp_name, 'aes-256-cbc', $secret_key, 0, '1234567890123456');

    // Now you have the decrypted email and company name
    // You can use $email and $comp_name as needed in your application
    
    // Example usage:
} else {
    // If email or comp_name is not set, prompt "Invalid request"
    echo "Invalid request: Email or company name is not set.";
}
?>
    ...
    <div class="row border rounded-5 p-1 bg-light shadow box-area" >
        ...
        <div class="col-lg-12 col-sm-10 right-box">
          <div class="row">
            ...
            <form  action="store_added_user.php" method="POST">
            <div class="row">
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="email" value="<?php echo $email ?>" class="form-control bg-light" id="email" name="email" placeholder="Email" required readonly>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="password">Password</label>
                        <i class="info-icon" data-toggle="tooltip" data-placement="right" title="a password here has been randomly generated for security reasons"> ⓘ</i>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control bg-light" id="companyName" name="companyName" placeholder="Company Name" required value="<?php echo $comp_name ?>" readonly>
                    </div>
                </div>
            </div>
