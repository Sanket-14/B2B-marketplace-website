...
<div class="main-content">
        ...
        <section>
            ...
            <h2 style="color: #23D375FF;">Customized EV Supplier Search</h2>
            
            <!-- Sub-header "Effortless Discovery at Your Fingertips" -->
            <h4>Effortless Discovery at Your Fingertips</h4>
            
            <!-- Text -->
            <p>Our platform's search functionality is tailored to the unique needs of the EV industry. Buyers can easily filter suppliers based on criteria like product type, supplier category, and location. This precision search simplifies finding the perfect supplier, saving time and enhancing decision-making.</p>
        </section>

        <!-- Section 2 (similar structure to section 1) -->
        <section>
            <!-- Header "Customized EV Supplier Search" -->
            <h2 style="color: #23D375FF;">In-depth Supplier Profiles</h2>
            
            <!-- Sub-header "Effortless Discovery at Your Fingertips" -->
            <h4>Unveiling Comprehensive Supplier Insights</h4>
            
            <!-- Text -->
            <p>Delve into detailed profiles of each supplier on our platform. These profiles showcase extensive information, including product ranges and customer ratings. This transparency equips buyers with all the necessary data to make well-informed collaboration choices.</p>
        </section>
        <!-- Section 3 (similar structure to section 1) -->
        <section>
            <!-- Header "Customized EV Supplier Search" -->
            <h2 style="color: #23D375FF;">Detailed Product Listings</h2>
            
            <!-- Sub-header "Effortless Discovery at Your Fingertips" -->
            <h4>A Closer Look at What's on Offer</h4>
            
            <!-- Text -->
            <p>Our platform's product listings are designed to give buyers a clear and comprehensive view of what suppliers offer. Each listing is detailed with high-quality images, in-depth descriptions, and full specifications, ensuring buyers have all the information they need at their fingertips.</p>
        </section>
