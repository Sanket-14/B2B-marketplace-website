...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($emailDomain == "gmail.com" || $emailDomain == "yahoo.com") {
            ...
            if ($email !== "admin@thevoltbridge.com") {
                ...
                if ($emailResult->num_rows > 0) {
                    ...
                    $error = "Company with this name is already registered by ".$companyRow['first_name']." ".$companyRow['last_name'].", please login or contact the respective person";
                }
            }
        }
    }
    ...
    if (empty($error)) {
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            echo 'window.location.href = "add_listing.php?companyName=" + companyName;';
            echo '</script>';
    ...
    <nav class="navbar navbar-default navbar-expand-lg shadow navbar-light" style="height:74px;" >
        ...
        <div class="row align-items-center">
            ...
            <div class="col" style="padding: 0px 0px 0px 0px;">
               <strong><a class="navbar-brand" href="./index.php" style="font-size: 24px; margin-top: 0px; ,argin-left:0px;">Volt<span style="color: rgb(40, 212, 120); ">Bridge</span></a></strong>
            </div>
        </div>
        </div>
</nav>
        ...
        <div class="col-lg-12 col-sm-10 right-box">
          <div class="row">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="businessTitle">Business Title<span style="color: red;">*</span></label><i class="info-icon" data-toggle="tooltip" data-placement="right" title="e.g., Sales manager etc."> ⓘ</i>
...
<option value="+995">+995</option>
                            ...
                            <input type="text" class="form-control  bg-light" id="phoneNumber" name="phoneNumber" style="width:4rem;" placeholder="Enter phone number" required>
                        </div>
                    </div>
                </div>
        ...
        <div class="input-group mb-3" style="justify-content:center">
            <button class="btn btn-lg btn-success fs-6" style=" width: 20rem; font-family:Arial; font-size:13.3333px; " type="submit">Next</button>
        </div>
